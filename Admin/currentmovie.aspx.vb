...
Partial Class Admin_addMovie
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            Try
                ...
                cmd = New SqlCommand("Insert into current_movie values ( '" & txtmovieName.Text & "','" & txtmovieType.Text & "','" & txtdirectorNm.Text & "','" & txtproducerNm.Text & "','" & txtactorNm.Text & "','" & txtactoressNm.Text & "','" & txtRelease.Text & "','" & temp & "')", cn)
                cmd.ExecuteNonQuery()
                cn.Close()
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles drplst_Current_Movie.SelectedIndexChanged
        cn.Open()

        Dim MovieDetail As String = "select * from current_movie where movie_name='" & drplst_Current_Movie.SelectedItem.ToString & "'"
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            Dim update As String = "update current_movie set movie_name= '" & txtmovieName.Text & "',movie_type='" & txtmovieType.Text & "',director_name='" & txtdirectorNm.Text & "',producer_name='" & txtproducerNm.Text & "',actor_name='" & txtactorNm.Text & "',actoress_name='" & txtactoressNm.Text & "',release_date='" & txtRelease.Text & "' where movie_id ='" & drplst_Current_Movie.SelectedIndex.ToString & "'"
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        Try
            ...
            cn.Open()
            Dim delete As String = "delete from current_movie where movie_name='" & drplst_Current_Movie.SelectedItem.ToString & "'"
    ...
    Protected Sub btnCancle_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        txtmovieid.Text = ("")
        txtmovieName.Text = ("")
        txtmovieType.Text = ("")
        txtdirectorNm.Text = ("")
